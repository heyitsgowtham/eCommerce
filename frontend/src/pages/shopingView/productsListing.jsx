...
import { fetchAllFilteredProducts } from "@/store/shop/productSlice/shopProductSlice";
import ShoppingProducTile from "@/components/shopingView/productTile";
    ...
    <div className="grid grid-col-1 md:grid-cols-[300px_1fr] gap-6 p-4 p-6">
      ...
      <div className="bg-background w-full rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
              {
                productList && productList.length > 0 ? productList.map(productItem => <ShoppingProducTile product={productItem}/>) : null
              }
        </div>
      </div>
    </div>
