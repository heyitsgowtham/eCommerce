...
function handleRemove(){
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <div onDragOver={handleDragOver} onDrop={handleDrop} className="mb-3 border-2 border-dashed rounded-lg p-4">
        <Input
          id="image-upload"
          type="file"
          className="hidden"
        ...
        />
        {
            ...
            </Label> : <div className="flex item-center justify-between">
